...
var tabFiltersURLs = {
    ...
    'communication_advocacy': [{'link': subcountyURL, 'type': 'Sub_County', 'filters': ['#rapid_assessment_tool_availability_chart_filter', '#tools_availability_chart_filter', '#prep_summary_tool_chart_filter', '#clinical_encounter_form_chart_filter', '#prep_register_availability_chart_filter', '#hepatitis_b_availability_chart_filter', '#hepatitis_c_availability_chart_filter', '#creatinine_availability_chart_filter']}],
