...
var tabFiltersURLs = {
    ...
    'commodity_management': [{'link': subcountyURL, 'type': 'Sub_County', 'filters': ['#PrEP_drug_dispensation_chart_filter','#training_national_PrEP_ME_tools_chart_filter','cadre_staff_dispensing_PrEP_chart_filter']}],
    'communication_advocacy': [{'link': subcountyURL, 'type': 'Sub_County', 'filters': ['#rapid_assessment_tool_availability_chart_filter','#tools_availability_chart_filter','#prep_summary_tool_chart_filter', '#clinical_encounter_form_chart_filter', '#prep_register_availability_chart_filter']}],
...
var charts = {
    ...
    'commodity_management': ['software_managing_prep_commodities_chart', 'facility_source_ARVs_chart', 'PrEP_drug_dispensation_chart','training_national_PrEP_ME_tools_chart','cadre_staff_dispensing_PrEP_chart'],
    'communication_advocacy': ['rapid_assessment_tool_availability_chart','tools_availability_chart','prep_summary_tool_chart', 'clinical_encounter_form_chart', 'prep_register_availability_chart','PrEP_clients_both_ever_initiated_and_currently_on_care_chart'],
