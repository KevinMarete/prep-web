...
var tabFiltersURLs = {
    ...
    'laboratory_service': [{'link': subcountyURL, 'type': 'Sub_County', 'filters': ['#access_creatinine_testing_facilities_chart_filter', '#creatinine_testing_equipment_availability_chart_filter', '#offsite_onsite_creatinine_testing_chart_filter', '#access_hep_b_testing_facilities_chart_filter', '#hep_b_testing_equipment_availability_chart_filter', '#offsite_onsite_hep_b_testing_chart_filter', '#access_hep_c_testing_facilities_chart_filter', '#hep_c_testing_equipment_availability_chart_filter', '#offsite_onsite_hep_c_testing_chart_filter']}],
