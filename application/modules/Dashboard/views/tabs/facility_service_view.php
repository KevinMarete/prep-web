            ...
            <div class="col-md-4">
                <div class="chart-wrapper">
                    <div class="chart-title">
                        ...
                        <div class="nav navbar-right">
                            <button data-toggle="modal" data-target="#facility_facility_level_chart_filter_modal" class="btn btn-warning btn-xs">
                                <span class="glyphicon glyphicon-filter"></span>
                            </button>
                        </div>
                    </div>
                    <div class="chart-stage">
                        <div id="facility_facility_level_chart"></div>
                    </div>
                    <div class="chart-notes">
                        <span class="facility_facility_level_chart_heading heading"></span>
                    </div>
                </div>
            </div>
            <div class="col-md-4">
...
<div class="modal fade" id="facility_facility_level_chart_filter_modal">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">×</span><span class="sr-only">Close</span></button>
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-sm-9">
                        <select id="facility_facility_level_chart_filter" size="1" data-filter_type="Sub_County"></select>
                    </div>
                    <div class="col-sm-3">
                        <button id="facility_facility_level_chart_filter_clear_btn" class="btn btn-danger btn-sm clear_btn"><span class="glyphicon glyphicon-refresh"></span> Reset</button>
                        <button id="facility_facility_level_chart_filter_btn" class="btn btn-warning btn-sm filter_btn"><span class="glyphicon glyphicon-filter"></span> Filter</button>
                    </div>
                </div>
            </div>
        </div>
